...
3. [Phase 1: Calibration](#3-phase-1-calibration)
4. [Layer 1: The Goal Intensity Model](#4-layer-1-the-goal-intensity-model)
5. [Phase 2: Pre-Match Setup](#5-phase-2-pre-match-setup)
6. [Phase 3: The Live Engine](#6-phase-3-the-live-engine)
7. [Phase 4: The Execution Engine](#7-phase-4-the-execution-engine)
8. [Layer 3: Probability → Edge → Sizing](#8-layer-3-probability--edge--sizing)
9. [Phase 5: The Orchestrator](#9-phase-5-the-orchestrator)
10. [Phase 6: The Dashboard](#10-phase-6-the-dashboard)
11. [Before Going Live: Validation Gates](#11-before-going-live-validation-gates)
12. [Risks and How We Manage Them](#12-risks-and-how-we-manage-them)
13. [Complete Parameter Reference](#13-complete-parameter-reference)
...
6. Activate cooldown: no new orders for ~50 seconds after goal
```

The cooldown exists because the Kalshi market needs time to reprice after a
goal. Placing orders in the first few seconds after a goal, before the market
has fully reacted, risks filling against stale book orders.
...
Trading controls:
  ...
  cooldown       — True for ~50 seconds after any event
